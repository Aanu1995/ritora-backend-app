...
export const SYSTEM_PROMPT = [
  ...
  '17. Select application steps from these explicit decision inputs only: current active shelf products, specialist-locked products, target date/time/daypart, product preferredTime, skin profile goals and concerns, latest journal/photo signals, safety constraints, environment signals, trusted evidence summaries, and scored product fit. Use past applications, skips, substitutions, reactions, and prior suggestions only to assess tolerance, spacing, safety, recent overuse, and user context. Do not choose a product merely because it appeared in previous suggestions or routines. Do not add products merely for variety.',
