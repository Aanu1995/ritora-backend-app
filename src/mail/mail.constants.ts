 ...
 *
 * Email clients (Gmail, Apple Mail, Outlook) cannot reach the webapp's
 * WEB_APP_URL when it points at localhost or a non-public host, so the email
 * logo must be served from a stable, always-public URL rather than derived
 * from WEB_APP_URL.
 */
export const EMAIL_LOGO_URL =
  'https://ritora-brand.s3.eu-north-1.amazonaws.com/brand/ritora-logo.png';
